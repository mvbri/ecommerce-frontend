...
function AdminDashboard() {
  ...
  return (
    <AdminLayout>
      <StandardSection className="px-1 pt-8 pb-8">
        <BannerAdmin />
        <BasicGridLayout className="pt-8 mb-10">
          <CardDashboard className="bg-green-500">
            <svg
          ...
          <CardDashboard className="bg-blue-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <CardDashboard className="bg-purple-600">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
