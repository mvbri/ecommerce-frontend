...
"
        >
          <h1
            className="mb-4 md:mb-6 p-[2rem] text-2xl md:text-3xl text-gray-800 text-center rounded-t-md
"
          >
            Inicio de sesión
          </h1>
          {!!errorResponse && (
            <div className="bg-red-500 w-80 text-center w-full m-auto text-white p-1 mb-3">
              {errorResponse}
            </div>
          )}
