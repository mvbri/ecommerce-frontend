    ...
    <article>
      <div className='flex flex-col md:flex-row mb-8'>
        <div className='w-full md:w-[50%]'>
          ...
          {images_products.length > 0 ? (<ImageGallery showPlayButton={false} items={images_products} />) : (<ImageGallery showThumbnails={false} disableSwipe={true}  showPlayButton={false} items={images_placeholder} />)}
        </div>
        <div className="product-details p-2 px-3">
          <h4 className='text-2xl md:text-4xl pb-8'>Precio sin I.V.A {product.price} Bs</h4>
          <h4 className='text-2xl md:text-4xl pb-8'>Precio con I.V.A {product.priceIVA} Bs</h4>
          <div>
            <NumberInput
            ...
            <div className="my-4">
              ...
              {auth.isAuthenticated ? (
                <button
                  ...
                  className="m-auto bg-secondary hover:bg-secondary-accent text-white py-2 px-8 rounded-md font-semibold"
                >
                  Agregar
          ...
          <div className="description">
            <h3 className='text-2xl md:text-4xl mb-4'>Descripción</h3>
